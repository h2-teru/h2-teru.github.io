...
export const ALL_SKILL_IDS = Object.keys(SKILL_DEFS);
export function applySkillsToTrace(base, skills, waveIndex) {
    let cfg = { ...base };
...
export function pickRandomSkills(count, exclude, rngSeed) {
