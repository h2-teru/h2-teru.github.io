...
function GlitchOverlay({ onDone }) {
    ...
    return (_jsxs("div", { ref: containerRef, style: { position: 'absolute', inset: 0, overflow: 'hidden', opacity: 0 }, children: [_jsx("canvas", { ref: canvasRef, width: W, height: H, style: {
                    ...
                    backgroundImage: 'repeating-linear-gradient(0deg, transparent 0px, transparent 1px, rgba(0,10,28,0.35) 1px, rgba(0,10,28,0.35) 2px)',
                } }), showLabel && (_jsxs("div", { style: {
                    ...
                    whiteSpace: 'nowrap', pointerEvents: 'none',
                        ...
                        }, children: "// ROUTING TO TARGET" }), _jsx("div", { style: {
                        ...
                        }, children: "HIDEOUT" }), _jsx("div", { style: {
                            fontSize: 10, color: 'rgba(255,255,255,0.35)',
                            letterSpacing: '0.12em', marginTop: 6,
                        }, children: "\u65B0\u5BBF\u5730\u4E0B \u00B7 SECTOR 7" })] }))] }));
}
// ── Main transition overlay ───────────────────────────────────────────────────
function LinkTransitionOverlay() {
    return (_jsxs("div", { className: "absolute inset-0 overflow-hidden clear-route-transition", children: [_jsx("div", { className: "absolute inset-0 clear-route-panel" }), _jsx("div", { className: "absolute left-1/2 top-1/2 clear-route-beam clear-route-beam-halo" }), _jsx("div", { className: "absolute left-1/2 top-1/2 clear-route-beam clear-route-beam-wide" }), _jsx("div", { className: "absolute left-1/2 top-1/2 clear-route-beam clear-route-beam-mid" }), _jsx("div", { className: "absolute left-1/2 top-1/2 clear-route-beam clear-route-beam-core" }), _jsx("div", { className: "absolute inset-0 flex items-center justify-center clear-route-copy", children: _jsxs("div", { className: "text-center font-mono", children: [_jsx("div", { className: "text-[9px] tracking-[0.45em] mb-3", style: { color: 'rgba(180,225,255,0.62)' }, children: "// ACCESS_GRANTED" }), _jsx("div", { className: "clear-route-null-text clear-route-glitch-text", "data-text": "NULL", children: "NULL" }), _jsx("div", { className: "clear-route-accepted-text clear-route-glitch-text", "data-text": "ACCEPTED", children: "ACCEPTED" })] }) })] }));
}
export function ScreenTransition() {
    ...
    useLayoutEffect(() => {
        ...
        const isClearLinkTransition = prev === 'hack' && (screen === 'wave_result' || (screen === 'result' && outcome === 'stage_cleared'));
    ...
    if (phase === 'idle')
        return null;
    return (_jsxs("div", { className: "absolute inset-0 z-[200] pointer-events-none overflow-hidden", children: [phase === 'glitch' && (_jsx(GlitchOverlay, { onDone: () => setPhase('idle') })), phase === 'fade' && (_jsx("div", { className: "absolute inset-0", style: {
                    background: '#000',
                    animation: 'title-route-fade-reveal 540ms ease-out forwards',
                } })), phase === 'link' && _jsx(LinkTransitionOverlay, {}), phase === 'cover' && (_jsxs("div", { className: "absolute inset-0 flex items-center justify-center", style: { background: 'rgba(0,0,0,0.97)' }, children: [_jsx("div", { className: "absolute inset-0 pointer-events-none", style: {
                            backgroundImage: 'repeating-linear-gradient(to bottom, rgba(77,163,255,0.025) 0px, rgba(77,163,255,0.025) 1px, transparent 1px, transparent 3px)',
                        } }), label && (_jsxs("div", { className: "text-center px-8", style: { fontFamily: 'monospace' }, children: [_jsx("div", { style: { fontSize: 8, color: 'rgba(77,163,255,0.5)', letterSpacing: '0.45em', marginBottom: 14 }, children: "// ROUTING TO TARGET" }), _jsx("div", { style: {
                                ...
                                }, children: label[0] }), _jsx("div", { style: { fontSize: 10, color: 'rgba(255,255,255,0.38)', letterSpacing: '0.1em', marginTop: 6 }, children: label[1] })] }))] })), phase === 'reveal' && (_jsx("div", { className: "absolute inset-0", style: {
