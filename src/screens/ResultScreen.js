...
export function ResultScreen() {
    ...
    return (_jsxs("div", { className: "relative w-full h-full flex flex-col bg-black text-white font-mono overflow-hidden scanlines", style: success ? {} : { background: '#0a0004' }, children: [!success && (_jsx("div", { className: "absolute inset-0 pointer-events-none z-0", style: { boxShadow: 'inset 0 0 100px rgba(255,77,109,0.25)' } })), _jsxs("div", { className: `relative z-10 flex flex-col h-full p-6 transition-opacity duration-500 ${visible ? 'opacity-100' : 'opacity-0'}`, children: [_jsx("div", { className: "scan-in", children: success ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "text-[10px] text-[#4da3ff]/50 tracking-[0.35em] mb-2", children: "// MISSION_COMPLETE" }), _jsx("div", { className: "leading-none font-normal tracking-[0.15em] glitch-title", "data-text": "NULLIFIED", style: {
                                    ...
                                    }, children: "DEAD" }), _jsx("div", { className: "text-[11px] text-white/30 mt-2.5 tracking-[0.12em]", children: "SENTINEL HAS LOCATED YOU \u00B7 RUN TERMINATED" })] })) }), _jsxs("div", { className: "mt-5 grid grid-cols-2 gap-[6px]", children: [_jsx(StatCell, { label: "MISSION", value: `#${String(level).padStart(3, '0')}` }), _jsx(StatCell, { label: "LAST WAVE", value: `${elapsed.toFixed(1)}s` }), _jsx(StatCell, { label: "ROTATIONS", value: String(rotations) }), success && (_jsx(StatCell, { label: "EFFICIENCY", value: `${Math.round(800 / Math.max(elapsed, 5))}x`, accent: true })), !success && (_jsx(StatCell, { label: "REWARD", value: "0 \u00A2", danger: true }))] }), success && acquiredIntel.length > 0 && (_jsxs("div", { className: "mt-5", children: [_jsx("div", { className: "text-[9px] tracking-[0.28em] text-white/25 mb-2", children: "// INTEL ACQUIRED" }), _jsx("div", { className: "flex flex-col gap-1.5", children: acquiredIntel.map(item => (_jsxs("div", { className: "flex items-center gap-2 px-3 py-2", style: {
