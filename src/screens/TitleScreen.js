...
function CodeStream({ speed = 22, delay = 0 }) {
...
function GlassPanel({ tx, ty, tz, rx, ry, w, h, glow = 0.46, data = [], speed = 22, delay = 0, }) {
    ...
    return (_jsxs("div", { style: {
            ...
            overflow: 'hidden',
        }, children: [_jsx(CodeStream, { speed: speed, delay: delay }), ['tl', 'tr', 'bl', 'br'].map(p => (_jsx("div", { style: {
                    position: 'absolute',
                    width: 13, height: 13,
                    ...
                    background: 'radial-gradient(ellipse at 50% 42%, rgba(77,163,255,0.08), transparent 62%), linear-gradient(135deg, rgba(77,163,255,0.08), transparent 38%, rgba(255,255,255,0.025) 72%, transparent)',
                    opacity: 0.7,
                } }), data.map((d, i) => _jsx(DataLabel, { ...d }, i))] }));
}
...
function GhostPanel({ tx, ty, tz, rx, ry, w, h, anim, dur, del, }) {
    const lines = [...CODE_LINES, ...CODE_LINES];
    return (_jsxs("div", { style: {
            position: 'absolute',
            width: w, height: h,
            ...
            opacity: 0,
        }, children: [_jsx("div", { style: { position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none' }, children: _jsx("div", { style: {
                    ...
                    }, children: lines.map((line, i) => _jsx("div", { children: line }, i)) }) }), ['tl', 'tr', 'bl', 'br'].map(p => (_jsx("div", { style: {
...
export function TitleScreen() {
    ...
    return (_jsxs("div", { className: "relative w-full h-full font-mono overflow-hidden select-none", style: { background: '#020812' }, children: [_jsx("style", { children: `
      ...
      ` }), _jsx("div", { className: "absolute inset-0 pointer-events-none", style: {
                ...
                } }), _jsx("div", { className: "absolute inset-0 pointer-events-none", style: { perspective: '720px', perspectiveOrigin: '46% 37%' }, children: _jsxs("div", { style: {
                        position: 'absolute',
                        left: '46%', top: '37%',
                        transformStyle: 'preserve-3d',
                        animation: 'scene-drift 16s ease-in-out infinite',
                    }, children: [_jsx(GlassPanel, { tx: -178, ty: -88, tz: -65, rx: 6, ry: 40, w: 238, h: 318, glow: 0.54, speed: 20, delay: 0, data: [
                            ...
                            ] }), _jsx(GlassPanel, { tx: 118, ty: -68, tz: -190, rx: 8, ry: -40, w: 218, h: 278, glow: 0.36, speed: 28, delay: -7, data: [
                                { val: 'FG 4', x: '55%', y: '12px' },
                                { val: '9.81143', x: '13px', y: '26px' },
                                { val: '──────────', x: '13px', y: '38px', size: 6 },
                                { val: '10.60958', x: '13px', y: '59%' },
                            ] }), _jsx(GlassPanel, { tx: -238, ty: -58, tz: -215, rx: 10, ry: 58, w: 188, h: 255, glow: 0.26, speed: 35, delay: -14, data: [
                                ...
                                filter: 'blur(16px)',
                                opacity: 0.54,
                            } }), _jsx(GlassPanel, { tx: 48, ty: -30, tz: -470, rx: 4, ry: 7, w: 208, h: 138, glow: 0.18, speed: 18, delay: -10, data: [
                                { val: 'SYS::0x2b', x: '12px', y: '11px', size: 7 },
                                { val: 'NET_TRACE', x: '12px', y: '25px', size: 7 },
                            ] }), _jsx(GlassPanel, { tx: 208, ty: 88, tz: 45, rx: 15, ry: -30, w: 165, h: 118, glow: 0.44, speed: 16, delay: -3, data: [
                                { val: 'PASS', x: '12px', y: '11px' },
                                { val: '0x31 · 0.31', x: '12px', y: '26px', size: 7 },
                            ] }), _jsx(GlassPanel, { tx: -18, ty: -248, tz: -55, rx: 72, ry: 6, w: 320, h: 195, glow: 0.2, speed: 30, delay: -18, data: [
                                { val: 'ALT_0x8f', x: '16px', y: '22%', size: 7 },
                                { val: '2.7183', x: '58%', y: '22%', size: 7 },
                            ] }), GHOST_CONFIG.map((g, i) => (_jsx(GhostPanel, { tx: g.tx, ty: g.ty, tz: g.tz, rx: g.rx, ry: g.ry, w: g.w, h: g.h, anim: g.anim, dur: g.dur, del: g.del }, i)))] }) }), _jsx("div", { className: "absolute pointer-events-none", style: {
                    left: '44%', top: '35%',
                    ...
                    zIndex: 6,
                } }), _jsxs("div", { className: `absolute left-0 right-0 z-10 ${exiting ? 'title-foreground-exit' : ''}`, style: {
                    top: '50%',
                ...
                }, children: [_jsx("img", { src: "/symbol.png", alt: "", style: { height: 28, width: 'auto', display: 'block', marginBottom: 12, filter: 'brightness(0) invert(1)' } }), _jsx("div", { style: {
                            fontSize: 8, letterSpacing: '0.46em',
                            color: 'rgba(77,163,255,0.38)',
                            marginBottom: 8, fontWeight: 300,
                        }, children: "// INTRUSION FRAMEWORK" }), _jsxs("div", { style: { position: 'relative', width: '100%', lineHeight: 0 }, children: [_jsx("img", { src: "/logo-text.png", alt: "NULLIFIER", style: { width: '100%', height: 'auto', display: 'block', filter: 'brightness(0) invert(1)', opacity: 0.95 } }), _jsx("img", { src: "/logo-text.png", "aria-hidden": true, style: {
                                    position: 'absolute', top: 0, left: 0, width: '100%', height: '100%',
                                    filter: 'brightness(0) invert(1) sepia(1) saturate(6) hue-rotate(310deg)',
                                    animation: 'logo-glitch-r 9s linear infinite',
                                    opacity: 0,
                                } }), _jsx("img", { src: "/logo-text.png", "aria-hidden": true, style: {
                                    position: 'absolute', top: 0, left: 0, width: '100%', height: '100%',
                ...
                }, children: _jsx("img", { src: "/symbol.png", alt: "", style: { height: 14, width: 'auto', filter: 'brightness(0) invert(1)', opacity: 0.5 } }) }), _jsx("div", { className: `absolute bottom-1.5 left-0 right-0 text-center z-10 pointer-events-none ${exiting ? 'title-foreground-exit' : ''}`, style: { fontSize: 8, letterSpacing: '0.3em', color: 'rgba(255,255,255,0.07)' }, children: "v0.1.4 \u00B7 NULLIFIER" }), exiting && (_jsx("div", { className: "absolute inset-0 z-30 pointer-events-none title-blackout", style: { background: '#000', opacity: 0 } }))] }));
}
