...
export function HomeScreen() {
  ...
  const tiltPermissionRef     = useRef<TiltPermissionStatus>(getCachedTiltPermission());
  ...
  useEffect(() => {
    ...
    const scheduleTiltUpdate = (nextTilt: TiltVector, raw: TiltRawReading) => {
