...
function HideoutMarketButtonPreview({ coins, intelCount, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { style: {
                    ...
                    height: 154,
                    overflow: 'hidden',
                }, children: [_jsxs("defs", { children: [_jsxs("radialGradient", { id: "hideout-market-shop-core", cx: "50%", cy: "52%", r: "68%", children: [_jsx("stop", { offset: "0%", stopColor: marketColor, stopOpacity: "0.2" }), _jsx("stop", { offset: "54%", stopColor: marketColor, stopOpacity: "0.07" }), _jsx("stop", { offset: "100%", stopColor: marketColor, stopOpacity: "0" })] }), _jsxs("linearGradient", { id: "hideout-market-panel-line", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [_jsx("stop", { offset: "0%", stopColor: marketColor, stopOpacity: "0" }), _jsx("stop", { offset: "48%", stopColor: marketColor, stopOpacity: "0.82" }), _jsx("stop", { offset: "100%", stopColor: marketColor, stopOpacity: "0" })] }), _jsxs("linearGradient", { id: "hideout-market-terminal", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [_jsx("stop", { offset: "0%", stopColor: marketColor, stopOpacity: "0.18" }), _jsx("stop", { offset: "52%", stopColor: "rgba(4,9,18,0.88)", stopOpacity: "1" }), _jsx("stop", { offset: "100%", stopColor: signalColor, stopOpacity: "0.1" })] })] }), _jsx("rect", { x: "22", y: "38", width: "238", height: "76", fill: "url(#hideout-market-shop-core)", opacity: "0.9" }), _jsx("path", { d: "M42 43 H240 L254 57 V103 H30 V55 Z", fill: "url(#hideout-market-terminal)", stroke: marketColor, strokeWidth: "1.1", strokeOpacity: "0.48", strokeLinejoin: "round" }), _jsx("path", { d: "M42 43 H240 L254 57", fill: "none", stroke: marketColor, strokeWidth: "1.2", strokeOpacity: "0.82" }), _jsx("path", { d: "M31 103 H254", stroke: "url(#hideout-market-panel-line)", strokeWidth: "1.3" }), _jsxs("g", { transform: "translate(54 55)", opacity: "0.78", children: [[0, 1, 2, 3, 4].map((i) => (_jsx("rect", { x: i * 10, y: 37 - (i < creditLevel ? 18 : 9), width: "6", height: i < creditLevel ? 18 : 9, fill: i < creditLevel ? marketColor : 'rgba(255,255,255,0.12)', opacity: i < creditLevel ? 0.78 : 0.28 }, i))), _jsx("line", { x1: "0", y1: "38", x2: "46", y2: "38", stroke: "rgba(255,255,255,0.18)", strokeWidth: "0.7" })] }), _jsxs("g", { transform: "translate(104 52)", children: [_jsx("path", { d: "M6 10 H73 L83 20 V56 H6 Z", fill: "rgba(2,7,15,0.92)", stroke: marketColor, strokeWidth: "1.2", strokeLinejoin: "round", strokeOpacity: "0.76" }), _jsx("path", { d: "M20 21 H68 V45 H20 Z", fill: "rgba(255,120,0,0.08)", stroke: marketColor, strokeWidth: "0.9", strokeOpacity: "0.58" }), _jsx("path", { d: "M20 21 L68 45 M68 21 L20 45", stroke: marketColor, strokeWidth: "0.55", strokeOpacity: "0.34" }), _jsx("path", { d: "M36 16 H58 M36 50 H58", stroke: signalColor, strokeWidth: "0.9", strokeOpacity: "0.55" }), _jsx("path", { d: "M42 27 H56 L61 33 L56 39 H42 L37 33 Z", fill: "rgba(255,120,0,0.22)", stroke: marketColor, strokeWidth: "1", strokeOpacity: "0.9" }), _jsx("path", { d: "M45 33 H58", stroke: "rgba(255,255,255,0.58)", strokeWidth: "0.8" }), _jsx("text", { x: "44", y: "9", textAnchor: "middle", fontSize: "5.8", letterSpacing: "1", fill: "rgba(255,255,255,0.28)", fontFamily: "monospace", children: "VENDOR_NODE" })] }), _jsxs("g", { transform: "translate(205 58)", children: [_jsx("path", { d: "M0 2 H31 L39 10 V38 H0 Z", fill: "rgba(2,7,15,0.74)", stroke: signalColor, strokeWidth: "0.8", strokeOpacity: "0.38" }), [0, 1, 2, 3].map((i) => (_jsx("rect", { x: 7 + i * 7, y: 12, width: "4", height: "14", fill: i < fileLevel ? signalColor : 'rgba(255,255,255,0.12)', opacity: i < fileLevel ? 0.62 : 0.22 }, i))), _jsx("path", { d: "M8 32 H30", stroke: marketColor, strokeWidth: "0.8", strokeOpacity: "0.5" })] }), _jsx("text", { x: "141", y: "116", textAnchor: "middle", fontSize: "6.2", letterSpacing: "1.1", fill: "rgba(255,120,0,0.42)", fontFamily: "monospace", children: "PERMANENT EQUIPMENT" })] }), _jsxs("div", { style: {
                    position: 'absolute',
                    left: 18,
                    right: 18,
                    bottom: 17,
