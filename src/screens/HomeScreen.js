...
function HideoutMarketButtonPreview({ coins, intelCount, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { style: {
                    ...
                    height: 154,
                    overflow: 'hidden',
                }, children: [_jsxs("defs", { children: [_jsxs("radialGradient", { id: "hideout-market-shop-core", cx: "50%", cy: "52%", r: "68%", children: [_jsx("stop", { offset: "0%", stopColor: marketColor, stopOpacity: "0.2" }), _jsx("stop", { offset: "54%", stopColor: marketColor, stopOpacity: "0.07" }), _jsx("stop", { offset: "100%", stopColor: marketColor, stopOpacity: "0" })] }), _jsxs("linearGradient", { id: "hideout-market-panel-line", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [_jsx("stop", { offset: "0%", stopColor: marketColor, stopOpacity: "0" }), _jsx("stop", { offset: "48%", stopColor: marketColor, stopOpacity: "0.82" }), _jsx("stop", { offset: "100%", stopColor: marketColor, stopOpacity: "0" })] })] }), _jsx("rect", { x: "22", y: "37", width: "238", height: "76", fill: "url(#hideout-market-shop-core)", opacity: "0.95" }), _jsx("line", { x1: "38", y1: "77", x2: "244", y2: "77", stroke: "url(#hideout-market-panel-line)", strokeWidth: "1.2" }), _jsx("line", { x1: "64", y1: "99", x2: "218", y2: "99", stroke: "rgba(255,120,0,0.28)", strokeWidth: "0.8" }), _jsxs("g", { transform: "translate(83 43)", children: [_jsx("path", { d: "M18 16 H98 L107 29 H9 Z", fill: "rgba(255,120,0,0.1)", stroke: marketColor, strokeWidth: "1.2", strokeLinejoin: "round", strokeOpacity: "0.82" }), _jsx("path", { d: "M18 29 H98 V70 H18 Z", fill: "rgba(4,9,18,0.82)", stroke: marketColor, strokeWidth: "1", strokeOpacity: "0.5" }), _jsx("path", { d: "M29 29 V16 M45 29 V16 M61 29 V16 M77 29 V16 M93 29 V16", stroke: marketColor, strokeWidth: "0.8", strokeOpacity: "0.38" }), _jsx("rect", { x: "35", y: "43", width: "46", height: "12", fill: "rgba(255,120,0,0.14)", stroke: marketColor, strokeWidth: "0.9", strokeOpacity: "0.7" }), _jsx("text", { x: "58", y: "51.4", textAnchor: "middle", fontSize: "7", letterSpacing: "1.2", fill: marketColor, fontFamily: "monospace", children: "GEAR" }), _jsx("circle", { cx: "58", cy: "29", r: "17", fill: "rgba(255,120,0,0.08)", stroke: marketColor, strokeWidth: "1.1", strokeOpacity: "0.48" }), _jsx("path", { d: "M50 28 H66 M58 20 V36", stroke: marketColor, strokeWidth: "1.6", strokeLinecap: "square" })] }), _jsx("g", { transform: "translate(46 86)", children: [0, 1, 2, 3, 4].map((i) => (_jsx("rect", { x: i * 10, y: 0, width: "6", height: i < creditLevel ? 14 : 7, fill: i < creditLevel ? marketColor : 'rgba(255,255,255,0.12)', opacity: i < creditLevel ? 0.74 : 0.28 }, i))) }), _jsxs("g", { transform: "translate(198 86)", children: [_jsx("rect", { x: "0", y: "0", width: "14", height: "14", fill: "rgba(77,163,255,0.12)", stroke: signalColor, strokeWidth: "0.8", strokeOpacity: "0.55" }), _jsx("rect", { x: "20", y: "0", width: "14", height: "14", fill: "rgba(255,120,0,0.12)", stroke: marketColor, strokeWidth: "0.8", strokeOpacity: "0.62" }), _jsx("path", { d: "M15 7 H19", stroke: "rgba(255,255,255,0.28)", strokeWidth: "0.8" })] })] }), _jsxs("div", { style: {
                    position: 'absolute',
                    left: 18,
                    right: 18,
                    bottom: 17,
