...
function HideoutMarketButtonPreview({ coins, intelCount, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { style: {
                    ...
                    height: 154,
                    overflow: 'hidden',
                }, children: [_jsxs("defs", { children: [_jsxs("radialGradient", { id: "hideout-market-shop-core", cx: "45%", cy: "50%", r: "70%", children: [_jsx("stop", { offset: "0%", stopColor: marketColor, stopOpacity: "0.24" }), _jsx("stop", { offset: "58%", stopColor: marketColor, stopOpacity: "0.08" }), _jsx("stop", { offset: "100%", stopColor: marketColor, stopOpacity: "0" })] }), _jsxs("linearGradient", { id: "hideout-market-shelf", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [_jsx("stop", { offset: "0%", stopColor: marketColor, stopOpacity: "0.13" }), _jsx("stop", { offset: "62%", stopColor: marketColor, stopOpacity: "0.05" }), _jsx("stop", { offset: "100%", stopColor: signalColor, stopOpacity: "0.1" })] })] }), _jsx("rect", { x: "22", y: "38", width: "238", height: "74", fill: "url(#hideout-market-shop-core)", opacity: "0.95" }), _jsx("rect", { x: "29", y: "43", width: "224", height: "66", fill: "url(#hideout-market-shelf)", stroke: "rgba(255,120,0,0.22)", strokeWidth: "0.8" }), _jsxs("g", { transform: "translate(34 49)", children: [_jsx("rect", { x: "0", y: "0", width: "75", height: "12", fill: "rgba(255,120,0,0.16)", stroke: marketColor, strokeWidth: "0.7", strokeOpacity: "0.64" }), _jsx("text", { x: "37.5", y: "8.5", textAnchor: "middle", fontSize: "6.5", letterSpacing: "0.9", fill: marketColor, fontFamily: "monospace", children: "BUY GEAR" }), _jsx("rect", { x: "80", y: "0", width: "89", height: "12", fill: "rgba(77,163,255,0.09)", stroke: signalColor, strokeWidth: "0.7", strokeOpacity: "0.45" }), _jsx("text", { x: "124.5", y: "8.5", textAnchor: "middle", fontSize: "6.5", letterSpacing: "0.75", fill: signalColor, fontFamily: "monospace", children: "UPGRADE BENCH" }), _jsx("rect", { x: "174", y: "0", width: "36", height: "12", fill: "rgba(4,9,18,0.9)", stroke: "rgba(255,255,255,0.14)", strokeWidth: "0.6" }), _jsx("text", { x: "192", y: "8.5", textAnchor: "middle", fontSize: "6", letterSpacing: "0.6", fill: "rgba(255,255,255,0.42)", fontFamily: "monospace", children: "PERM" })] }), _jsx("g", { transform: "translate(34 66)", children: [
                            ['HEAT', '-18%', '450¢', marketColor],
                            ['ROUTE', 'NOISE', '900¢', signalColor],
                            ['CACHE', '+20%', '980¢', '#b44fff'],
                        ].map(([name, effect, price, color], i) => (_jsxs("g", { transform: `translate(${i * 53} 0)`, children: [_jsx("rect", { x: "0", y: "0", width: "48", height: "37", fill: "rgba(4,9,18,0.9)", stroke: String(color), strokeWidth: "0.9", strokeOpacity: "0.68" }), _jsx("rect", { x: "4", y: "4", width: "40", height: "9", fill: `${String(color)}1f`, stroke: String(color), strokeWidth: "0.55", strokeOpacity: "0.7" }), _jsx("text", { x: "24", y: "10.6", textAnchor: "middle", fontSize: "6", letterSpacing: "0.7", fill: String(color), fontFamily: "monospace", children: name }), _jsx("text", { x: "5", y: "21", fontSize: "5.6", letterSpacing: "0.5", fill: "rgba(255,255,255,0.55)", fontFamily: "monospace", children: effect }), _jsx("rect", { x: "4", y: "26", width: "18", height: "7", fill: `${String(color)}24`, stroke: String(color), strokeWidth: "0.55" }), _jsx("text", { x: "13", y: "31.2", textAnchor: "middle", fontSize: "5.5", letterSpacing: "0.35", fill: String(color), fontFamily: "monospace", children: price }), _jsx("rect", { x: "26", y: "26", width: "18", height: "7", fill: "rgba(255,120,0,0.72)" }), _jsx("text", { x: "35", y: "31.4", textAnchor: "middle", fontSize: "5.8", letterSpacing: "0.5", fill: "#050505", fontFamily: "monospace", children: "BUY" })] }, name))) }), _jsxs("g", { transform: "translate(199 66)", children: [_jsx("rect", { x: "0", y: "0", width: "44", height: "37", fill: "rgba(4,9,18,0.92)", stroke: signalColor, strokeWidth: "0.9", strokeOpacity: "0.58" }), _jsx("text", { x: "22", y: "8.2", textAnchor: "middle", fontSize: "5.7", letterSpacing: "0.55", fill: signalColor, fontFamily: "monospace", children: "TIER I" }), _jsx("path", { d: "M12 14 H31 L27 10 M31 14 L27 18", fill: "none", stroke: marketColor, strokeWidth: "0.9", strokeOpacity: "0.9" }), _jsx("text", { x: "22", y: "24.5", textAnchor: "middle", fontSize: "5.7", letterSpacing: "0.55", fill: marketColor, fontFamily: "monospace", children: "TIER II" }), [0, 1, 2, 3].map((i) => (_jsx("rect", { x: 8 + i * 7, y: 29, width: "5", height: "4", fill: i < poweredSlots ? marketColor : 'rgba(255,255,255,0.12)', opacity: i < poweredSlots ? 0.76 : 0.25 }, i)))] }), _jsxs("g", { transform: "translate(42 115)", opacity: "0.58", children: [_jsx("text", { x: "0", y: "3.5", fontSize: "5.8", letterSpacing: "0.7", fill: "rgba(255,255,255,0.2)", fontFamily: "monospace", children: "STOCK" }), [0, 1, 2, 3, 4, 5].map((i) => (_jsx("rect", { x: 34 + i * 28, y: "0", width: "18", height: "4", fill: i < listedGoods ? marketColor : 'rgba(255,255,255,0.1)', opacity: i < listedGoods ? 0.72 : 0.22 }, i)))] })] }), _jsxs("div", { style: {
                    position: 'absolute',
                    left: 18,
                    right: 18,
                    bottom: 17,
