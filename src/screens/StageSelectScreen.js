...
export function StageSelectScreen() {
    ...
    return (_jsxs("div", { className: "relative w-full h-full flex flex-col text-white font-mono overflow-hidden", style: { background: '#020812' }, children: [_jsx(BoardBackdrop, {}), _jsxs("div", { className: "shrink-0", style: {
                    ...
                    boxShadow: 'none',
                            ...
                            background: 'linear-gradient(to bottom, rgba(0,0,0,0.26) 0%, rgba(1,5,12,0.18) 38%, rgba(3,11,22,0.06) 72%, transparent 100%)',
                        } }), _jsxs("div", { children: [_jsx("button", { onClick: goHome, style: {
                                    background: 'none',
                                    border: 'none',
                                    cursor: 'pointer',
                                    padding: 0,
                                ...
                                }, onMouseEnter: e => (e.currentTarget.style.color = '#ffffff'), onMouseLeave: e => (e.currentTarget.style.color = '#ffffff'), children: "\u2190 BACK" }), _jsx("div", { style: { marginTop: 4, fontSize: 7, color: 'rgba(77,163,255,0.3)', letterSpacing: '0.3em' }, children: "DARKNET BOARD" })] }), _jsxs("div", { style: { textAlign: 'right' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 5, justifyContent: 'flex-end' }, children: [_jsx("div", { className: "animate-flicker", style: {
                                            width: 6,
                                            height: 6,
                                            borderRadius: '50%',
                                            background: '#4da3ff',
